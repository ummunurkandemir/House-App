<?php
// This file is created official user login page
...
<head>
    <title>Official User Login Page</title>
    <meta charset="utf-8">
            ...
            <div>
                <form action="operation.php" method="GET">
                    <div class="input-group mr-5">
                        ...
                        <input type="email" name="userMail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.com$" title="Lütfen e-posta adresini bu şekilde giriniz: [abc@abc.com]" class="form-control input_mail" id="mail" value="" placeholder="E-posta adresi" autocomplete="off" required>
                    </div>
                    <div id="mailErrorMessage" style="margin-left:42px ;color:#bd2130"></div>
                    <div class="input-group mb-2 mt-2">
                        <div class="input-group-prepend ">
                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                        </div>
                        <input type="password" id="password" name="reg_password" class="form-control input_pass" placeholder="Şifre" pattern="^[a-zöçğışüA-ZÖÇĞIŞÜ0-9]{8,16}$" maxlength="16" required />
                    ...
                    <div id="passwordErrorMessage" style="margin-left:42px ;color:#bd2130"></div>
                    ...
                    <div class=" mt-5 login_container">
                        <button type="submit" name="SubmitSignInForOfficialUser" class="btn login_btn">Giriş Yap</button>
                    </div>
                </form>
            </div>
            <div class="mt-4">
                <div>
                    Kurumsal Hesabın Yok Mu? <a href="OfficialUserSignUpPage.php" class="ml-2 text-danger">Kayıt Ol</a>
                </div>
            </div>
        </div>
    </div>
