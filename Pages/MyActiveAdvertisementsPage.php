<?php
// This file is created for displaying active advertisements of official user
$cookiename = 'currentPageForAdvertisements';
$value = 'MyActiveAdvertisementsPage';
...
<head>
    <meta charset="UTF-8">
    <title>My Active Advertisements</title>
    ...
    <main style="display: flex;flex-direction: column;justify-content: center;align-items: center">
        <div style="width: 50%;">
            ...
            <div id="buttonGroup" style="display:flex;flex-direction:row;justify-content: center;align-items: center">
                ...
                <button type="button" class="btn active btn-outline-secondary" style="display: flex;flex: 2">Aktif İlanlarım</button>
